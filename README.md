...
[![CI test](https://github.com/azita-abdollahi/moleculer-db-adapter-scylla/actions/workflows/ci.yaml/badge.svg)](https://github.com/azita-abdollahi/moleculer-db-adapter-scylla/actions/workflows/ci.yaml)
